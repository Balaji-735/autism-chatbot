...
import { Send, Loader2, Bot, User, FileText, ExternalLink } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20">
      <div className="container mx-auto max-w-[1600px] py-8 px-4">
        <div className="grid grid-cols-1 gap-4 h-[calc(100vh-4rem)]">
          {/* Chat Section */}
          ...
          <CardHeader className="border-b">
            <div className="flex items-start justify-between">
              <div>
                ...
                <CardDescription>
                  Ask questions about autism-related documents. Powered by RAG technology.
                </CardDescription>
              </div>
              <HealthIndicator />
            </div>
                        ...
                        {message.sources && message.sources.length > 0 && (
                          <div className="w-full space-y-2 mt-2">
                            <div className="flex items-center justify-between">
                              ...
                              <p className="text-xs text-muted-foreground" title="Lower distance = higher relevance. Distance of 0 = perfect match, 1 = no match">
                              ...
                              {message.sources.map((source, idx) => {
                                ...
                                const displayName = source.filename || 
                                  (source.metadata.source 
                                    ? source.metadata.source.split("/").pop()?.split("\\").pop()
                                    : `Source ${idx + 1}`);
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center justify-between mt-2 pt-2 border-t border-border/50">
                                      <p className="text-xs text-muted-foreground">
                                        <span className="font-medium">Distance:</span> {source.score.toFixed(3)}
                                        <span className="ml-2 text-xs" title="Lower is better. 0 = perfect match, 1+ = less relevant">
                                          {source.score < 0.3 ? "🎯 Excellent match" : source.score < 0.5 ? "✅ Good match" : "⚡ Fair match"}
                                        </span>
                                      </p>
                                    </div>
                                  </div>
